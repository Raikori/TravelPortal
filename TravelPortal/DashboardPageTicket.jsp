...
<title>Admin Dashboard</title>
	...
	<%
        ...
        String query= "SELECT * FROM msticket";
	...
	<div>
		...
		<table>
			...
			<tr>
				...
				<td><%=vecTicket.get(i).getDepartDate()%></td>
				<td>Rp.<%=vecTicket.get(i).getEcoPrice()%></td>
				<td>Rp.<%=vecTicket.get(i).getBusPrice()%></td>
				<td><%=vecTicket.get(i).getAvaSeat()%></td>
				<td>					
					<ul>
					    <li style="display:inline-block;">
					        <a href="updateTicketPage.jsp?id=<%=vecTicket.get(i).getId()%>"style="text-decoration:none; color:#00FFFF;"><input class="edit" type="submit" value="Edit"></a>
					    </li>
					    <li style="display:inline-block;">
					        <a href="./process/ControllerTicket.jsp?deleteId=<%=vecTicket.get(i).getId()%>" style="text-decoration:none; color:#00FFFF;"><input class="delete" type="submit" value="Delete"> </a>
					    </li>
					</ul>
				</td>
			</tr>
		...
		<a href="insertTicketPage.jsp"><input class="insert"type="submit" value="Insert Ticket"></a>
